...
public class CursFederat extends CursClient {
    ...
    public CursFederat(String nivellFederat, String numCarnet, int referencia, int id_curs, int id_client, String data, int hores,String dni,double preu,double preufinal) {
